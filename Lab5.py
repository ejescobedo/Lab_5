...
#In order to complete this lab we were asked to implement the Min-Heap data structure and use it do the heapsort, we would do it by
...
#mean heap structure. Then for the part of the extract min, I will take the value at the index 0 (minimum value) which I will return
#and change the value of the index 0, to the last value of the heap, and then shrink by 1 the heap. Further explanation will be given
#with the methods
...
class Heap:
    ...
    #Insertion of the new value and using min heap with the new value to maintain the min heap properties
    def insert(self, val):
